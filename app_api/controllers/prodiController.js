...
const getAllProdi = async (req, res) => {
    try {
        ...
        // Mengambil semua prodi dari database dan populate data Prodi berdasarkan Prodi_id
        const prodi = await Prodi.find().populate("Prodi_id", "nama singkatan"); // Mengambil field 'nama' dari Fakultas
...
const createProdi = async (req, res) => {
    // Mmebuat instance prodi baru dari data yang diterima
...
const updateProdi = async (req, res) => {
    try {
        ...
        // Memperbarui fakultas_id yang ada di request body
